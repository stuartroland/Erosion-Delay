...
SRDPresetManager::SRDPresetManager(AudioProcessor* inProcessor)
	...
	mProcessor(inProcessor)
{
	...
	mPresetDirectory = File::getSpecialLocation(File::userDocumentsDirectory).getFullPathName() + directorySeparator + pluginName;
...
SRDPresetManager::~SRDPresetManager()
{

}

void SRDPresetManager::getXmlForPreset(XmlElement* inElement)
{
...
void SRDPresetManager::loadPresetForXml(XmlElement* inElement)
{
...
int SRDPresetManager::getNumberOfPresets()
{
	return mLocalPresets.size();
}

String SRDPresetManager::getPresetName(int inPresetIndex)
{
	return mLocalPresets[inPresetIndex].getFileNameWithoutExtension();
}

void SRDPresetManager::createNewPreset()
{
	auto& parameters = mProcessor->getParameters();
...
void SRDPresetManager::savePreset()
{
...
void SRDPresetManager::saveAsPreset(String inPresetName)
{
...
void SRDPresetManager::loadPreset(int inPresetIndex)
{
...
bool SRDPresetManager::getIsCurrentPresetSaved()
{
	return mCurrentPresetIsSaved;
}

String SRDPresetManager::getCurrentPresetName()
{
	return mCurrentPresetName;
}

void SRDPresetManager::storeLocalPresets()
{
	mLocalPresets.clear();

	for (DirectoryIterator di(File(mPresetDirectory), false, "*" + (String)PRESET_FILE_EXTENTION, File::TypesOfFileToFind::findFiles); di.next();)
	{
